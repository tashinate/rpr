-- Comprehensive Database Pattern Updates and Optimization (Fixed)
...
-- Update global system config to mark placeholder system as updated (fixed JSON)
INSERT INTO global_system_config (config_key, config_value)
VALUES ('placeholder_system_version', jsonb_build_object(
  'version', '2.0',
  'updated_at', now(),
