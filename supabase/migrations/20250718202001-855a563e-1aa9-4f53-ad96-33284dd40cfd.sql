-- Fix authentication function to properly use pgcrypto extension
...
BEGIN
  ...
  LOOP
    -- Use pgcrypto's crypt() function to verify password against stored hash
    IF public.crypt(password_input, cipher_record.password_hash) = cipher_record.password_hash THEN
