...
-- Drop the duplicate constraint and recreate it properly
ALTER TABLE public.user_visit_stats DROP CONSTRAINT IF EXISTS user_visit_stats_license_key_id_visit_date_key;
-- Keep the unique_license_visit_date constraint as it's the proper one