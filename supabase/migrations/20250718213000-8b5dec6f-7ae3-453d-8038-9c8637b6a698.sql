-- Fix authenticate_user_session function with correct schema reference for extensions
...
BEGIN
  ...
  LOOP
    -- Use crypt() function to verify password against stored hash with proper schema
    IF extensions.crypt(password_input, cipher_record.password_hash) = cipher_record.password_hash THEN
