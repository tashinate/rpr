-- Update generate_license_with_preset function to enforce minimum max_uses of 1
...
BEGIN
  ...
  -- Enforce minimum max_uses of 1 if provided
  IF max_uses_input IS NOT NULL THEN
    final_max_uses := GREATEST(max_uses_input, 1);
  ELSE
    final_max_uses := NULL;
  END IF;
