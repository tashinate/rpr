-- Fix create_auth_cipher_enhanced function with proper schema prefix
...
BEGIN
  ...
  -- Hash the password using bcrypt with proper schema prefix
...
BEGIN
  ...
  -- Hash the new password using bcrypt with proper schema prefix
